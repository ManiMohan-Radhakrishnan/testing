...
import RaddxGuildNfts from "../raddx/raddx-guild-nfts";
...
const RaddxNfts = ({ guildUserMenuPermissionList }) => {
                        ...
                        <Dropdown.Menu align="start">
                          {filter?.nftCollection.map((obj, i) => (
                            <Dropdown.Item
                              ...
                              color={"#000"}
                              onClick={() =>
                                handleGuildFilter(obj, "nft_collection")
                              }
                            >
                              <FaCheckCircle
                                fill={obj.checked ? "#F47411" : "#898989"}
                        ...
                        >
                          {filter.level.map((obj, i) => (
                            <Dropdown.Item
                              ...
                              color={"#000"}
                              onClick={() =>
                                handleGuildFilter(obj, "nft_level")
                              }
                            >
                              <FaCheckCircle
                                fill={obj.checked ? "#F47411" : "#898989"}
                        ...
                        .map((obj, i) => (
                          ...
                          >
                            ...
                            <BiX
                              ...
                              size={18}
                              onClick={() =>
                                handleGuildFilter(obj, "owned", true)
                              }
                            />
                          </div>
                        ))}
