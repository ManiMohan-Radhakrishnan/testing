    ...
    <Popover>
      <Popover.Body>
        <p className="password-terms">
          Tournament is in progress, you can't revoke NFT's from bundle at the
          moment
        </p>
      </Popover.Body>
    </Popover>
  ...
  return (
    ...
    >
      <Offcanvas.Body className="bundle-body-container">
        {detailLoading ? (
          <div className="bundle-loading-box">
          ...
          <>
            <div className="bundle-nft-details">
              <div className="bundle-head-content">
                <div className="bundle-title" onClick={handleClose}>
                  <h2>
                    {" "}
                    Rental History
                    <BsArrowLeft
              ...
              <div className="bundle-body-content">
                <div className="user-detail-header">
                  <div className="mynft-card-list ">
                    <div className="mynft-card-bundle">
            ...
            <div className="sticky-bottom-box">
              ...
              <p className="hint">
                * You cannot revoke NFTs for 10 mins before and 30 mins after a
                tournament.
              </p>
            </div>
          </>
      ...
      <div className="popup-secondary">
        {type == "confirm" && (
          <div className="confirm-modal modal-box">
            <h5>Do you want to remove the selected NFTs from bundle?</h5>
        ...
        {type == "success" && (
          <div className="success-modal modal-box">
            ...
            <h5>NFT revoked successfully</h5>
            <div className="btn-block">
              <button
                className="btn btn-dark"
                onClick={() => {
