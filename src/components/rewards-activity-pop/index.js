...
const RewardsActivityPop = ({
  ...
  const getUTCoins = async (page) => {
    try {
      console.log("first");
      const result = await getUTCoinsList("reward_point", page);
      setMoreLoading(true);
  ...
  return (
    <>
      <div className="ut-coin-container">
        <Offcanvas
          show={rewardsPop}
          onHide={() => setRewardsPop(!rewardsPop)}
          placement="end"
                            ...
                            <div className="card-body">
                              ...
                              <p className="wallet-num d-flex gap-2 justify-content-center w-100">
                                ...
                                <span className="d-flex">
                                  <FormattedNumber
                                    className="wallet-num"
                                    descriptionClassName="fs-6 w-100 text-center"
                                    value={user?.assert_balances?.reward_point}
                                    prefix="($"
                                    suffix=")"
...
export default RewardsActivityPop;
